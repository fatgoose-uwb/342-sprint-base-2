 ...
 *  propose a solution. No coding is required for getting this 5 pt extra credit.
 *  Note: when submitting homework, please keep the #define line commented, otherwise the bot will
 *  fail at this test.
 */
