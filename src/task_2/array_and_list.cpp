...
template<class T>
void ArrayList<T>::push_front(const T &value) { // 5
    /*
...
template<class T>
void ArrayList<T>::push_back(const T &value) { // 2.5
    /*
...
template<class T>
void ArrayList<T>::remove(T &val) { // 5
    /*
 ...
 */
template<class T>
void ArrayList<T>::merge(const List<T> &other_list) {   // 5
    /*
